...
import type { EnumType, ExtractKeys, Filter } from './types.js';
...
export class AllowedFilter<Model extends LucidModel> {
  ...
  public setNullable(isNullable = true): this {
  ...
  public static exact<Model extends LucidModel>(
    name: string,
    internalName?: ExtractKeys<ModelAttributes<InstanceType<Model>>>,
    shouldAddRelationConstraint = true,
    arrayValueDelimiter?: string,
  ): AllowedFilter<Model> {
    this.setFilterArrayValueDelimiter(arrayValueDelimiter);

    return new AllowedFilter<Model>(name, new FiltersExact<Model>(shouldAddRelationConstraint), internalName);
  }
  ...
  public static partial<Model extends LucidModel>(
    ...
    return new AllowedFilter<Model>(name, new FiltersPartial<Model>(shouldAddRelationConstraint), internalName);
  }
  ...
  public static beginsWithStrict<Model extends LucidModel>(
    ...
    return new AllowedFilter<Model>(name, new FiltersBeginWithStrict<Model>(shouldAddRelationConstraint), internalName);
  }
  ...
  public static endsWithStrict<Model extends LucidModel>(
    ...
    return new AllowedFilter<Model>(name, new FiltersEndsWithStrict<Model>(shouldAddRelationConstraint), internalName);
  }
  ...
  public static operator<Model extends LucidModel>(
    name: string,
    filterOperator: EnumType<typeof FilterOperator>,
    boolean: 'and' | 'or' = 'and',
    internalName?: ExtractKeys<ModelAttributes<InstanceType<Model>>>,
    shouldAddRelationConstraint = true,
    arrayValueDelimiter?: string,
    ...
    return new AllowedFilter<Model>(
      name,
      new FiltersOperator<Model>(shouldAddRelationConstraint, filterOperator, boolean),
      internalName,
    );
  }
}
